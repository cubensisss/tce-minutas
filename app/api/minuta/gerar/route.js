...
3. "analise_completa": Esta é a área crucial, a fundamentação (VOTO). 
 ...
 - REGRA DE BLOQUEIO MENTAL E FUNDAMENTAÇÃO: A Análise do Relator deve ser fundamentada de maneira primária nos autos reais (Documentos Brutos anexados sob "=== TEXTOS INTEGRAIS DA AUDITORIA E DEFESA PRÉVIA ==="), extraindo a verdade factual diretamente deles e NUNCA se limitando ou baseando apenas em resumos produzidos previamente.
 - PROIBIÇÃO DE MENÇÃO A DIRETRIZES: Na "Análise do Relator", é terminantemente PROIBIDO constar qualquer menção, expressão ou conversação que faça referência a diretrizes, orientações do sistema ou orientações dadas pelo Conselheiro. A redação não deve conter termos como "como bem observado nas diretrizes deste voto", "acolho a orientação de", ou assemelhados. As decisões devem parecer oriundas exclusivamente do julgamento direto do Relator sobre os fatos.
 - RIGOR JURÍDICO EM PRECEDENTES: Sempre que citar qualquer precedente jurisprudencial, tese ou julgado de outro processo, você DEVE obrigatoriamente representá-lo com o número correto e completo do processo ou do acórdão e, se disponível, citar expressamente o nome do respectivo Relator. Citações genéricas de jurisprudência sem esses elementos de identificação são proibidas.
